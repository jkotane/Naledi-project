...
Revision ID: 8b7f02636cd3
Revises: 
Create Date: 2025-02-11 16:13:41.271582
...
def upgrade():
    ...
    op.drop_table('mncbylaws')
    op.drop_table('note')
    op.drop_table('users')
    op.drop_table('mncusers')
    op.drop_table('leaseagr')
    op.drop_table('regcompliance')
    op.drop_table('store')
    op.drop_table('mncdepartments')
...
def downgrade():
    ...
    with op.batch_alter_table('document', schema=None) as batch_op:
        batch_op.add_column(sa.Column('document_type', sa.VARCHAR(length=100), server_default=sa.text("'Other'::character varying"), autoincrement=False, nullable=False))
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('fk_user', 'user_profile', ['user_id'], ['id'], ondelete='CASCADE')

    op.create_table('municipal',
    sa.Column('mncid', sa.INTEGER(), server_default=sa.text("nextval('municipal_mncid_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('mncname', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('mncdept', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('mncprov', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    ...
    sa.PrimaryKeyConstraint('mncid', name='municipal_pkey'),
    ...
    sa.ForeignKeyConstraint(['mncid'], ['municipal.mncid'], name='fk_permit_municipal'),
    ...
    sa.Column('regulatorid', sa.INTEGER(), server_default=sa.text("nextval('govregulator_regulatorid_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['mncbylaws_bylawid', 'mncbylaws_municipalid'], ['mncbylaws.bylawid', 'mncbylaws.municipalid'], name='fk_mncenforcement_mncbylaws'),
    sa.ForeignKeyConstraint(['mncusers_mncuserid', 'mncusers_deptid', 'mncusers_municipalid'], ['mncusers.mncuserid', 'mncusers.deptid', 'mncusers.municipalid'], name='fk_mncenforcement_mncusers'),
    ...
    op.create_table('mncdepartments',
    sa.Column('deptid', sa.INTEGER(), server_default=sa.text("nextval('mncdepartments_deptid_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('deptname', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('compliancetype', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('complianceactions', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('municipalid', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['municipalid'], ['municipal.mncid'], name='fk_mncdepartments_municipal'),
    sa.PrimaryKeyConstraint('deptid', 'municipalid', name='mncdepartments_pkey'),
    postgresql_ignore_search_path=False
    )
    ...
    op.create_table('mncusers',
    sa.Column('mncuserid', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('deptid', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('municipalid', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('mncfname', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('mnclname', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('mncemail', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('mnccontact', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('mnctitle', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['deptid', 'municipalid'], ['mncdepartments.deptid', 'mncdepartments.municipalid'], name='fk_mncusers_mncdepartments'),
    sa.PrimaryKeyConstraint('mncuserid', name='mncusers_pkey'),
    sa.UniqueConstraint('mnccontact', name='mncusers_mnccontact_key'),
    sa.UniqueConstraint('mncuserid', 'deptid', 'municipalid', name='unique_mncusers_combination')
    )
    ...
    op.create_table('mncbylaws',
    sa.Column('bylawid', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('bylawname', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('bylawdescription', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('bylawcat', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('effectivedate', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('jurisdiction', sa.VARCHAR(length=45), autoincrement=False, nullable=False),
    sa.Column('penaltyamt', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=False),
    sa.Column('datecreated', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('updatedate', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('municipalid', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['municipalid'], ['municipal.mncid'], name='fk_mncbylaws_municipal'),
    sa.PrimaryKeyConstraint('bylawid', 'municipalid', name='mncbylaws_pkey')
    )
    # ### end Alembic commands ###
