...
Revision ID: 2ca32c11a279
Revises: 6965a045310e
Create Date: 2025-03-09 11:02:59.682169
...
revision = '2ca32c11a279'
down_revision = '6965a045310e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('health_compliance', schema=None) as batch_op:
        ...
        batch_op.alter_column('employees',
               ...
               type_=sa.JSON(),
               existing_nullable=True)
        batch_op.drop_constraint('fk_store', type_='foreignkey')
        batch_op.create_foreign_key(None, 'store_details', ['store_id'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('health_compliance', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('fk_store', 'store_details', ['store_id'], ['id'], ondelete='CASCADE')
        batch_op.alter_column('employees',
