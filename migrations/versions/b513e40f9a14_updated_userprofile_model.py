...
Revision ID: b513e40f9a14
Revises: 
Create Date: 2025-02-05 18:45:15.494541
...
def downgrade():
    ...
    sa.Column('bylawid', sa.INTEGER(), server_default=sa.text("nextval('mncbylaws_bylawid_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('mncid', sa.INTEGER(), autoincrement=True, nullable=False),
